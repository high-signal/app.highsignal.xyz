...
import { ForumUser, User } from "@interfaces/types"
import { handler as discourseHandler } from "../../../discourse/src/handler"
...
const runTestSuite = async () => {
    ...
    const mockContext = {
        awsRequestId: "e2e-test-request-id",
    }
    ...
    await discourseHandler(mockEvent, mockContext)
