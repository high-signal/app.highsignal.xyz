...
const { clearLastChecked } = require("../discourse_forum/clearLastChecked")
...
async function runEngine({ signalStrengthName, user_id, project_id, signalStrengthUsername, testingData }) {
    ...
    try {
        ...
        // TODO: This is broken as the first run is setting lastUpdated even if it has not been updated yet
